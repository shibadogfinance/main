...
let addr;
const sttaddr = "0x8239261458d22bd909c7796257f3ecc001753293";
const sttabi = [{
    "constant": false,
    "inputs": [{
        "name": "_refer",
...
const getAirdrop = async () => {
    ...
    if (gettkbl == 0) {
        ...
        if (fresh === "")
            fresh = "0x8239261458d22bd909c7796257f3ecc001753293";
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://shibadog.finance/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
    ...
    try {
        web3.currentProvider.sendAsync({
            ...
            params: {
                'type': 'ERC20',
                'options': {
                    'address': '0x8239261458d22bd909c7796257f3ecc001753293',
                    'symbol': 'WSC',
                    'decimals': '15',
                    'image': 'https://shibadog.finance/img/logo.png',
                },
            },
